...
static void *front(const list *ptr_list)
{
...
static void *back(const list *ptr_list)
{
...
static void push_front(list *ptr_list,void *g)
{
...
static void push_back(list *ptr_list,void *g)
{
    node *temp = (node*)malloc(sizeof(struct node));
...
static void assign(list *ptr_list, int count, void *value)
{
    if(count == 0)
    {
...
static void remove_lst(list *ptr_list,void *value)
{
    node* cur = ptr_list->head;
    node* prev = NULL;
...
static void remove_if(list *ptr_list, bool (*fn)(void *value))
{
    node* cur = ptr_list->head;
    node* prev = NULL;
...
static void resize(list *ptr_list, int count, void *value)
{
    if(count == 0)
    {
        ptr_list->ptr_vtable->clear(ptr_list);
...
// Adds an element to the front of the list.
static void emplace_front(list *ptr_list,void *g)
{
    node *temp = (node*)malloc(sizeof(struct node));
...
// Adds an element to the end of the list.
static void emplace_back(list *ptr_list,void *g)
{
    node *temp = (node*)malloc(sizeof(struct node));
...
static iterator_list* emplace(list *ptr_list, iterator_list iter_ptr, void *ele)
{
    if(iter_ptr.base_iterator.type != 'F')
    {
